...
export class ENIP {
     ...
     * @memberof ENIP
     */
    readonly get establishing(): boolean;
    /**
     ...
     * @memberof ENIP
     */
    readonly get established(): boolean;
    /**
     * Get ENIP Session ID
     *
     * @readonly
     ...
     * @memberof ENIP
     */
    override connect(IP_ADDR: string): Promise<any>;
    /**
     ...
     * @memberof ENIP
     */
    override destroy(exception: Exception): void;
