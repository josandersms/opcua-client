    ...
    constructor(endpointUrl: string, namespace: string) {
        ...
        this.ready = new Promise(async (resolve, reject) => {
            try {
                ...
                this.client = await this.createClient({discoveryUrl: `${this.endpointUrl}/discovery`, clientCertificateManager: this.clientCertificateManager, certificateFile: 'certs/client_certificate.pem', privateKeyFile: 'private/private_key.pem', securityPolicy: SecurityPolicy.Basic256Sha256, securityMode: MessageSecurityMode.SignAndEncrypt});
